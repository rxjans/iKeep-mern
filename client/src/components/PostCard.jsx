...
function PostCard({post}) {
  return (
    <div className='group w-full relative overflow-hidden mt-8 border xl:w-[430px] h-[366px] shadow-2xl dark:border-gray-600 hover:border-2 rounded-md transition-all mx-2'>
